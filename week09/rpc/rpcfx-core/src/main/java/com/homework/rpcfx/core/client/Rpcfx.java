...
import com.homework.rpcfx.core.api.LoadBalancer;
import com.homework.rpcfx.core.api.Router;
import com.homework.rpcfx.core.api.RpcfxRequest;
import com.homework.rpcfx.core.api.RpcfxResponse;
import com.homework.rpcfx.core.aspect.impl.CustomAspect;
...
//        return (T) Proxy.newProxyInstance(Rpcfx.class.getClassLoader(), new Class[]{serviceClass}, new RpcfxInvocationHandler(serviceClass, url, filters));
    return (T) JdkDynamicProxyGenerator.generateJdkProxy(new CustomAspect(), serviceClass, url,
        filters);
  }
